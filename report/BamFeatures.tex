...
% TODO: Better caption
    ...
    \begin{table}[]
        \centering
        \caption{List of the Bamfiles provided that have reference solutions with the respective gtf, experiment strandness, and the runtime. The bam file were processed on the bioclient grid with -Xmx10g and queued with QueueGridForRefTable.sh}
    ...
    \begin{table}[h]
        ...
        \resizebox{0.7\textwidth}{!}{%
            \begin{tabular}{|c|c|c|}
                ...
                y.ns.2.bam   & Saccharomyces\_cerevisiae.R64-1-1.75.gtf & y.ns.2re.annot      \\ \hline
